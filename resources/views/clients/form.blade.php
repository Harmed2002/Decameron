...
<form class="form-send-client">
    ...
    <div class="row">
        <div class="col-12 col-sm-6 mb-3">
            ...
            @endphp
            <select class="form-control select2 TipoId" name="TipoId" id="TipoId" required onchange="inactivateFields()"
                tabindex="1">
        ...
        <div class="col-12 col-sm-6 mb-3">
            ...
            <input type="number" min="0" class="form-control idCliente" placeholder="Identificación" name="idCliente"
                id="idCliente" required tabindex="2" value="{{ $person->pers_identif ?? '' }}">
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-12 col-sm-6 mb-3">
            ...
            <input type="text" class="form-control Nom1" placeholder="Primer Nombre" 
        ...
        <div class="col-12 col-sm-6 mb-3">
            ...
            <input type="text" class="form-control Nom2" placeholder="Segundo Nombre" 
